...
public class FuncExpr extends Expr {
    ...
    public enum FuncName {
        COUNT, SUM, AVG, COUNT_DISTINCT, EXTRACT, LOWER, IMPALA_APPROX_COUNT_DISTINCT, ROUND, MAX, MIN, FLOOR, CEIL, EXP, LN, LOG10, LOG2, SIN, COS, TAN, SIGN, STRTOL, RAND, RANDOM, FNV_HASH, ABS, STDDEV, SQRT, MOD, PMOD, YEAR, CAST, CONV, SUBSTR, MD5, CRC32, UNIX_TIMESTAMP, CURRENT_TIMESTAMP, UNKNOWN
    }
    ...
    protected static Map<FuncName, String> functionPattern = ImmutableMap.<FuncName, String>builder()
            ...
            .put(FuncName.EXTRACT, "extract(%s from %s)").put(FuncName.UNKNOWN, "UNKNOWN(%s)")
            .put(FuncName.LOWER, "lower(%s)").build();
    ...
    public static FuncExpr lower(Expr expr) {
        return new FuncExpr(FuncName.LOWER, expr);
    }
